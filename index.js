...
handle(uHandle, "/get-a-quote", requestHandlers, "quotes");
handle(uHandle, "/contact/leavemessage", requestHandlers, "leavemessage");
handle(uHandle, "/get-a-quote/leavequote", requestHandlers, "leavequote");
handle(uHandle, "/testimonials", requestHandlers, "testimonials");
handle(uHandle, "/subscribe", requestHandlers, "subscribe");
...
handle(aHandle, "/adminpage/quotes", requestHandlers, "adminQuotes");
handle(aHandle, "/adminpage/subscribed", requestHandlers, "adminSubscribed");
